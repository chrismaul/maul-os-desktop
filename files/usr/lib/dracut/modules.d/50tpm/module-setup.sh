...
install() {
  ...
  inst_libdir_file 'libtss2-esys.so'
  inst_libdir_file 'libtss2-rc.so'
  inst_libdir_file 'libtss2-mu.so'
  inst_libdir_file 'libtss2-tcti-cmd.so'
  inst_libdir_file 'libtss2-tcti-device.so'
  inst_libdir_file 'libtss2-tcti-mssim.so'
  inst_libdir_file 'libtss2-tcti-swtpm.so'
  inst_libdir_file 'libtss2-tcti-tabrmd.so'
